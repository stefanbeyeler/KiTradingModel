...
envsubst '${DATA_SERVICE_PORT} ${NHITS_SERVICE_PORT} ${RAG_SERVICE_PORT} ${LLM_SERVICE_PORT} ${TCN_SERVICE_PORT} ${HMM_SERVICE_PORT} ${EMBEDDER_SERVICE_PORT} ${WATCHDOG_SERVICE_PORT}' \
